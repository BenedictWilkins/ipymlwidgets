...
from traitlets import observe, Instance, Dict as TDict, Tuple as TTuple
import ipycanvas
...
class Image(W.Box):
    ...
    client_size = TTuple(allow_none=False, default_value=(0, 0)).tag(sync=False)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._mouse_down_event.on_dom_event(self._on_client_mousedown)
        ...
        self._mouse_up_event.on_dom_event(self._on_client_mouseup)
        ...
        self._mouse_move_event.on_dom_event(self._on_client_mousemove)

        self._client_resize_event = E.Event(
            source=self,
            watched_events=["resize"],
            prevent_default_action=False,
        )
        self._client_resize_event.on_dom_event(self._on_client_resize)
    ...
    def _on_client_resize(self, raw_event: dict):
        self.client_size = (
            raw_event["boundingRectWidth"],
            raw_event["boundingRectHeight"],
        )

    def _on_client_mousedown(self, raw_event: dict):
    ...
    def _on_client_mouseup(self, raw_event: dict):
    ...
    def _on_client_mousemove(self, raw_event: dict):
